...
<div class="container">
<h2>Encriptor AES Mode 128 CTR</h2>
<form method="post">
  <div class="form-group row">
    <label for="pesan" class="col-4 col-form-label">Ketik Pesannya</label> 
    <div class="col-8">
      <input id="pesan" name="pesan" type="text" required="required" class="form-control">
    </div>
  </div>
  <div class="form-group row">
    <label for="kunci" class="col-4 col-form-label">Kunci Enkripsinya</label> 
    <div class="col-8">
